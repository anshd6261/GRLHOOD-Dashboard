...
const downloadReportPdf = async (orders) => {
  ...
  autoTable(doc, {
    startY: 158,
    head: [['Order ID', 'AWB', 'Type', 'Reason', 'Date', 'Att.', 'Note']],
    body: rows,
    theme: 'plain',
    styles: { font: 'helvetica', fontSize: 9, cellPadding: 6, textColor: ink, lineColor: [236, 234, 239], lineWidth: 0.5, overflow: 'linebreak' },
    headStyles: { fontStyle: 'bold', fontSize: 8.5, textColor: [255, 255, 255], fillColor: pink, cellPadding: 7 },
    alternateRowStyles: { fillColor: [250, 249, 251] },
    columnStyles: {
      0: { fontStyle: 'bold', cellWidth: 58 },
      1: { cellWidth: 82, font: 'courier', fontSize: 8 },
      2: { cellWidth: 34, halign: 'center', fontStyle: 'bold' },
      3: { cellWidth: 120 },
      4: { cellWidth: 74, fontSize: 8 },
